...
public class NewsListActivity extends BaseActivity {
        ...
        if (isNetworkAvailable(getApplicationContext())) {
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    data = getData("https://newsapi.org/v1/articles?source=" + NEWS_SOURCE + "&sortBy=top&apiKey=" + API_KEY, urlParameters);
    ...
    // to get json data
    public static String getData(String targetURL, String urlParameters) {
        URL url;
